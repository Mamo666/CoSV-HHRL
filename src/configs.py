...
light_configs = {
    ...
    'use_goal': True,       # 仅在FullIndependent中使用
    ...
    'encoder_load_path': 'VAE/newEnc_recon_0822/dataset_2',

    'var': .6,
    'tau': 0.005,  # 软更新参数
    'gamma': 0.95,  # .95  20步
    'batch_size': 64,  # 批大小
    # 'memory_capacity': 5000,                                           # NOTE: 注意检查开始学习的时机
...
CAV_configs = {
    ...
    'cav': {
        ...
        'T': 2,    # 不宜设置过大，因为要攒够这么多步的obs才能开始决策和学习  # Here, 测试时T基本上都设为1
    ...
    'batch_size': 64,       # 批大小                                         # NOTE: 注意检查开始学习的时机
    # 'memory_capacity': 1440000,    # fixed goal 14
    # 'learn_start_ratio': 0.2,    # fixed goal
    'memory_capacity': 720000,    # fixed goal 14
