...
class Environment:
    ...
    def get_head_cav_obs(self, cav_id, next_phase):
        ...
        def get_light_state_to_car(vehicle_id, next_phase, use_left_time):
            ...
            if vehicle_id is not None:
                ...
                if use_left_time:
                    if current_phase % 3 != 0:  # 当前是黄红，直接返回1
                        curr_phase_left_time = [1.]
                    else:
                ...
                if current_phase % 3 != 0 and phase_index // 3 == next_phase:  # 当前是别人的黄红且下一相位是自己的绿
                    curr_phase_flag = [0.5]
                elif current_phase == phase_index:  # 当前是自己的绿
                    curr_phase_flag = [1.]
                else:
                    curr_phase_flag = [0.]
        ...
        return ego_state + [dx, dv] + get_light_state_to_car(cav_id, next_phase, use_left_time=True)
